                        ...
                        <tbody>
                            <tr class="cart-item" v-for="(cart,index) in get_carts" :key="index">
                                <td class="product-remove" style="width:165px">
                                    ...
                                    <a href="#" @click.prevent="showModal(cart)" class="btn btn-success btn-sm my-1" title="Remove this item">
                                ...
                                <td class="product-name  ">
                                    ...
                                    <span class="bg-dark rounded-circle p-2 ml-1 text-white " style="width:30px; height:30px">{{cart.product.discount}}%</span>
                                </td>
                                <td class="product-price">
                                    <span class="amounte">${{ cart.product.discount_price || cart.product.price}}</span>
                                </td>
                                <td class="product-quantity">
                                    <input min="1"  :value="cart.qty" @change="change_product_qty($event, cart.product.id)" type="number" :max="product.stock - product.minimum_amount">
                                </td>
