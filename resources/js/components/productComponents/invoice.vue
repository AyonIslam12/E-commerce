       ...
       <div class="card card-body printableArea mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-left">
                                <address>
                                    <h3><b class="text-danger">Ayon's Web Store</b></h3>
                            ...
                            <div class="pull-right text-right">
                                <address>
                                    ...
                                    <p class="text-muted m-l-30">
                                        ...
                                        +88{{get_billing_address.phone}}, <br>
                                    </p>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="(cart,index) in get_latest_saved_cart.order_products" :key="index">
                                            ...
                                            <td class="text-right"> $ {{parseInt(cart.qty) * cart.price}} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="pull-right m-t-30 text-right">
                                <p>Sub-Total amount: ${{get_latest_saved_cart.subtotal}}</p>
                                <hr>
                                <h3><b>Total :</b> ${{get_latest_saved_cart.total}}</h3>
                            </div>
