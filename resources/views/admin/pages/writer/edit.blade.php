            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header d-flex justify-content-between">
                        <div class="card-title">Update Writer</div>
                        <a class="btn btn-secondary" href="{{ route('writer.index') }}">Back</a>
                    </div>
                    <hr />

                    <form class="update_form" action="{{ route('writer.update',$writer->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" name="name" class="form-control" id="input-21" value="{{ $writer->name }}" />
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                               ...
                               <textarea name="description" id="mytextarea2"  class="form-control">{!! $writer->description !!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img src="{{ asset('uploads/'.$writer->image) }}" height="50px" alt="no">
                            </div>
                        </div>
