...
<div class="content-wrapper">
    ...
    <!-- Breadcrumb-->
     @include('admin.partials.breadCrumb',['title' => 'Main Category'])
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
            <div class="card">
                             ...
                             <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <a href="{{ route('main-category.edit',$item->id) }}" class="btn btn-success waves-effect waves-light m-1">
                                            <i class="fa fa-edit"></i><span>Edit</span>
                                        </a>
                                        <a type="button" href="{{ route('main-category.destroy',$item->id) }}"
