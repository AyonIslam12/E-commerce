        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="update_form" action="{{ route('brand.update',$brand->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                               <span class="text-danger name"></span>
                                <input type="text" name="name" class="form-control" id="input-21" value="{{ $brand->name }}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img src="{{ asset('uploads/'.$brand->logo) }}" height="50px" alt="no">
                            </div>
                        </div>
