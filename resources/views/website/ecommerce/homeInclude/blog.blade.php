<div class="blog-area box-shadow bg-fff">
    ...
    <div class="feautred-active right home2 left-right-angle">
        ...
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{asset('contents/website')}}/img/blog/2.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
        ...
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{asset('contents/website')}}/img/blog/3.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
        ...
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{asset('contents/website')}}/img/blog/4.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
        ...
        <div class="blog-wrapper">
            <div class="blog-img mtb-30">
                <a href="#">
                    <img src="{{asset('contents/website')}}/img/blog/5.jpg" alt="" />
                </a>
            </div>
            <div class="blog-content home3-hover">
                <h3><a href="#">hello world</a></h3>
