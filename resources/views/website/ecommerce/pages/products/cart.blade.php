            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                    ...
                    <div class="cart-product bg-fff box-shadow mb-50">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 930px;"><div class="owl-item active" style="width: 217.5px; margin-right: 15px;"><div class="product-wrapper bl">
                            ...
                            </div></div><div class="owl-item active" style="width: 217.5px; margin-right: 15px;"><div class="product-wrapper bl">
                                <div class="product-img">
                                    <a href="#">
                            ...
                            </div></div><div class="owl-item" style="width: 217.5px; margin-right: 15px;"><div class="product-wrapper bl">
                                <div class="product-img">
                                    <a href="#">
