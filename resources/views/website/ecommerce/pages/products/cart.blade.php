                    ...
                    <div class="cart-product bg-fff box-shadow mb-50">
                        ...
                        <div class="cart-active left-right-angle left home2 owl-carousel owl-theme owl-loaded">
                            <div class="owl-stage-outer">
                                <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 930px;">
                                    <div class="owl-item active" style="width: 217.5px; margin-right: 15px;">
                                    ...
                                    <div class="owl-item" style="width: 217.5px; margin-right: 15px;">
                                        <div class="product-wrapper bl">
                                            <div class="product-img">
                                                <a href="#">
