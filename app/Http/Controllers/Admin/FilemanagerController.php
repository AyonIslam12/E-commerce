...
class FilemanagerController extends Controller
{
   public function store_file(Request $request){
       if($request->hasFile('fm_file')){
        $path = Storage::put('file_manager',$request->file('fm_file'));
   ...
   public function get_files(){
       ...
       return \view('admin.pages.product.components.file_manager_image_body',\compact('images'));
   }

   public function delete_file(Request $request,Image $image){
